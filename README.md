# Larvae Dispenser <img src="docs/images/logo/Diptera_logo_small.png?raw=true" height="55" align="right" alt="">
...
2. **Aliquoting**
   ...
   6. Make sure the bottle doesn’t run out of water and does not reach the bottom line marked on the bottle.
   7. Once you reach the end of the larvae, you can add water to the bottle (see below, in *Notes*, how to open the bottle) which will dilute the density of the larvae but will allow you to continue counting them without reaching the bottom line of the bottle.
